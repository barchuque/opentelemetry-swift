Pod::Spec.new do |spec|
  spec.name = "OpenTelemetryProtocolExporterGrpc"
  spec.version = "1.10.1"
  spec.summary = "Swift OpenTelemetryProtocolExporterGrpc"
  ...
  spec.source_files = "Sources/Exporters/OpenTelemetryProtocolGrpc/**/*.swift"
  ...
  spec.dependency 'OpenTelemetryProtocolExporterCommon', spec.version.to_s
